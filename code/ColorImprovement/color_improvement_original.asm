...
;	Exclusively for the USA release of Fusion!
;----------------------------------------------
...
; First block of palettes
.org 0x0828DD7C ;in (U), beginning of suit palettes
...
; Atmospheric stabilizer palette (CHECK)
; This has extra bytes at the end, could cause graphical issues
.org 0x08326FF0 ;in (U)
...
; Habitation pad palette (Extra 0E past the end) (CHECK)
; This has extra bytes at the end, could cause graphical issues
.org 0x0834A904 ;in (U)
...
.org 0x083BF792	; 0x083BF792 ;in (U)
