...
* **SpineShark** - For porting the original Sequence Breaking hack into the Japanese version of Metroid Fusion, Fast Text hack, Unlock all gallery images hack, Skip Adam conversations hack, and also several bugfixes to biospark's Laguage Selector hack for MF_J.
